  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pb-24">
        <div className="container">
          <div className="bg-soft rounded-3xl p-8 md:p-12 text-center">
            <h3 className="font-display font-extrabold text-2xl md:text-3xl text-primary mb-3">
            ...
            <Button asChild variant="hero" size="lg">
              <a href="#precio">Empezar mi acompañamiento <ArrowRight /></a>
            </Button>
          </div>
        </div>
      </section>
